...
def chart(col1,col2,roles=roles_default):
    ...
    graph_one.append(fig)
    #fig.update_layout(title_text='January 2013 Sales Report')
    layout_one = dict(title = 'Which of the following describes your current job?')   
    #fig.show()
    ...
    layout_two = dict(title = '% of Popular languages')
    #fig.show()
    graph_two = []
    graph_two.append(fig2)
    figures = []
...
chart('LanguageHaveWorkedWith','LanguageWantToWorkWith')